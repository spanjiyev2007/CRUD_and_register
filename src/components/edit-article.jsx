...
const EditArticle = () => {
    ...
    return (
        <div className='text-center'>
            <h1 className='fs-2'>Updade article</h1>
            <div className='w-75 mx-auto'>
                <Form formName={'Updade'} formSubmit={formSubmit} title={title} setTitle={setTitle} description={description} setDescription={setDescription} body={body} setBody={setBody} />
            </div>
        </div>
    )
}
